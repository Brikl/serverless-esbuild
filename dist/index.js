...
class EsbuildPlugin {
    ...
    bundle(incremental = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Promise.all(this.rootFileNames.map(entry => {
                const config = Object.assign(Object.assign({}, this.buildOptions), { external: [...this.buildOptions.external, ...this.buildOptions.exclude], entryPoints: [entry], outdir: path.join(this.originalServicePath, BUILD_FOLDER, path.dirname(entry)), platform: 'node', incremental });
