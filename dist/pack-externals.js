        ...
        if (moduleVersion) {
            ...
            try {
                ...
                if (!ramda_1.isEmpty(peerDependencies)) {
                    ...
                    const peerModules = getProdModules.call(this, ramda_1.compose(ramda_1.map(([external]) => ({ external })), ramda_1.toPairs)(peerDependencies), packageJsonPath);
...
function packExternalModules() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const packageJsonPath = this.buildOptions.packagePath || path.join(utils_1.findProjectRoot(), './package.json');
        ...
        if (!ramda_1.isEmpty(packageSections)) {
            this.options.verbose && this.serverless.cli.log(`Using package.json sections ${ramda_1.join(', ', ramda_1.keys(packageSections))}`);
        }
        ...
        const compositeModules = ramda_1.uniq(getProdModules.call(this, externalModules, packageJsonPath));
